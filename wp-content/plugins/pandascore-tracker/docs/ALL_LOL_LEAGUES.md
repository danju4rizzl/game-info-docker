...
| LCP | LCP |
| LTA | LTA |
| T-esports Championship | TEC |
| Hitpoint Winter | HW |
| Americas Challengers | AC |
| Esports World Cup | EWC |
| Legends Cup | LGC |
| LIT | LIT |
| KCX3: Karmine Corp vs The World | KCX3 |
| Red Bull League of Its Own | RBLOIO |
| Superdome | Superdome |
| Esports Shanghai Masters | ESM |
| MEG | MEG |
| Elite Series Benelux Masters | ESLOL |
| Sigma Cup | SC |
| Prime Pokal | PRM Pokal |
| Coupe de France | CdF |
| Asia Star Challengers Invitational | ASCI |
| Elements League | EL |
| LHE | LHE |
| Intel Arabian Cup | IAC |
| LMF | LMF |
| LCK Academy | LCK AS |
| DDH | DDH